---
title: Raspberry Pi (at least V4, 4GB) + OSMO fl2k Dongle
date: 2026-02-04
weight: 10
_build:
  list: never
  render: always
description: >
    Selection for < 300€, max. SNR with 29 equally strong carriers 40dB, bandwidth limited to LW, MW and 49m SW
---
...
* only 8 bit resolution, therefore SNR limited, but sufficient for most LW and MW bands as well as SW 49m
