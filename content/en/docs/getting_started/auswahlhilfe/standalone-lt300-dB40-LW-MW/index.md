...
_build:
  ...
  render: always
description: >
    Selection for < 300€, max. SNR with 29 equally strong carriers 40dB, bandwidth limited to LW, MW
---
...
* only 8 bit resolution, therefore SNR very limited, but sufficient for most LW and MW bands
