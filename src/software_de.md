...
**ACHTUNG:** Falls auf dem PC ein Virenscanner installiert ist, schlägt dieser häufig beim ersten Start des Programms Alarm. Da unsere Software natürlich keine Malware ist, können Sie die Ausführung normalerweise problemlos zulassen. Für das Anschlagen der Virenscanner kann es mehrere Ursachen geben, z.B. dass unsere Software bei Verwendung des Red-Pitaya STEMLAB notwendigerweise Zugriffe auf die LAN-Schnittstelle durchführt sowie die IP-Adresse des STEMLAB abfragt. Diese Dinge sind typische Trigger für Virenscanner, in unserem Fall aber harmlos. Wer der exe trotzdem nicht trauen möchte, kann alternativ den Sourcecode direkt unter Python ausführen. Wir weisen darauf hin, dass wir keine professionellen Softwareentwickler sind und unsere Programme nicht durch Code-Signing registriert haben. 
