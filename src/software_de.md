...
**ACHTUNG:** Falls auf dem PC ein Virenscanner installiert ist, kann es passieren, dass er beim ersten Start des Programms Alarm schlägt. Da unsere Software natürlich keine Malware ist, können Sie die Ausführung normalerweise problemlos zulassen. Wer der exe trotzdem nicht trauen möchte, kann alternativ den Sourcecode direkt unter Python ausführen. Wir weisen darauf hin, dass wir keine professionellen Softwareentwickler sind und unsere Programme nicht durch Code-Signing registriert haben. Wir bemühen uns aber, die Ursache Für das Anschlagen der Virenscanner zu identifizieren und in zukünftigen releases zu berücksichtigen.
