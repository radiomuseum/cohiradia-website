...
&nbsp;&nbsp;&nbsp;Remark: There is another [alternativ installation method](https://www.radiomuseum.org/cohiradia/SDKARTE_method2.html) that was used in the past, but it is no longer recommended as the first choice.
