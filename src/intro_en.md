...
3) to create artificial AM bands that allow programs to be simulated, such as those that existed in the early days of radio but for which no recordings exist. See the section [COHI Jukebox](https://www.radiomuseum.org/dsp_cohiradia.cfm?synthetic) for more information.
